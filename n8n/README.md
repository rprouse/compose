...
This is my version tuned to the way I want to run it.
...
✅ [**Ollama**](https://ollama.com/) - Is expected to be on the local host machine.
...
install. Follow the steps below to get started.
